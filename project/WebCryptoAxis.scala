...
/** Virtual axis distinguishing the Web Crypto (browser) JS row fromdefault Node.js. Use [[VirtualAxis.WeakAxis]] so a browser row may depend on an axis-less upstream row.
